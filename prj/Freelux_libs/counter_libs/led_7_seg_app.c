...
//
//    LOGA(USER,"buttonTimeTick: %d\n",buttonTimeTick);
//
//    if(buttonTimeTick <= (stimer_get_tick()/SYSTEM_TIMER_TICK_1MS)){
//        buttonTimeTick = (stimer_get_tick()/SYSTEM_TIMER_TICK_1MS) + TIME_LED7SEG_TASK_MS ; //10ms
//    }
//    else{
//        return ;
//    }
