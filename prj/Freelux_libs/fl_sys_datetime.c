...
u32 RTC_OFFSET_TIME = 1752473460; // 14/07/2025-11:31:00
...
//    uint32_t tick = timestamp_seconds;  //  32kHz = 1/~32,000 tick
	//clock_set_32k_tick(tick);
	u8 u32_arr[4] = { U32_BYTE0(timestamp_seconds), U32_BYTE1(timestamp_seconds), U32_BYTE2(timestamp_seconds), U32_BYTE3(timestamp_seconds) };
