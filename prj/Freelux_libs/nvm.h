...
#define STORAGE_TIMESTAMP_START			0x0100
#define STORAGE_TIMESLOT_MAP			0x0101
#define STORAGE_TIMESLOT_CURRENT		0x0102
#define STORAGE_TIMESLOT_UNSPECIFIED	0x0103
