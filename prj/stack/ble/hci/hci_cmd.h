...
/* Own Address Type */
typedef enum {
	OWN_ADDRESS_PUBLIC = 0, OWN_ADDRESS_RANDOM = 1, OWN_ADDRESS_RESOLVE_PRIVATE_PUBLIC = 2, OWN_ADDRESS_RESOLVE_PRIVATE_RANDOM = 3,
} own_addr_type_t;

/* Advertising_Channel_Map */
typedef enum {
	BLT_ENABLE_ADV_37 = BIT(0), BLT_ENABLE_ADV_38 = BIT(1), BLT_ENABLE_ADV_39 = BIT(2), BLT_ENABLE_ADV_ALL = (BLT_ENABLE_ADV_37 | BLT_ENABLE_ADV_38
			| BLT_ENABLE_ADV_39),
} adv_chn_map_t;
 ...
 */
typedef enum {
	BLC_ADV_DISABLE = 0x00, BLC_ADV_ENABLE = 0x01,
} ll_adv_en_t;
 ...
 */
typedef enum {
	SCAN_TYPE_PASSIVE = 0x00, SCAN_TYPE_ACTIVE = 0x01,
} scan_type_t;
...
/* LE_Scan_Enable */
typedef enum {
	BLC_SCAN_DISABLE = 0x00, BLC_SCAN_ENABLE = 0x01,
} scan_en_t;

/* Filter_Duplicates */
typedef enum {
	DUP_FILTER_DISABLE = 0x00, DUP_FILTER_ENABLE = 0x01,
} dupFilter_en_t;
...
typedef enum {
	BLE_PHY_1M = 0x01, BLE_PHY_2M = 0x02, BLE_PHY_CODED = 0x03,
} le_phy_type_t;

typedef enum {
	PHY_PREFER_1M = BIT(0), PHY_PREFER_2M = BIT(1), PHY_PREFER_CODED = BIT(2),
...
typedef enum {
	CODED_PHY_PREFER_NONE = 0, CODED_PHY_PREFER_S2 = 1, CODED_PHY_PREFER_S8 = 2,
...
/* Advertising_Handle */
typedef enum {
	ADV_HANDLE0 = 0x00, ADV_HANDLE1 = 0x01, ADV_HANDLE2 = 0x02,
} adv_handle_t;
...
/* Advertising_SID */
typedef enum {
	ADV_SID_0 = 0x00, ADV_SID_1 = 0x01, ADV_SID_2 = 0x02, ADV_SID_3 = 0x03,
} adv_sid_t;
...
/* Operation */
typedef enum {
	DATA_OPER_INTER = 0x00, DATA_OPER_FIRST = 0x01, DATA_OPER_LAST = 0x02, DATA_OPER_COMPLETE = 0x03, DATA_OPER_UNCHANGEED = 0x04,
} data_oper_t;

/* Fragment_Preference */
typedef enum {
	DATA_FRAGM_ALLOWED = 0x00, DATA_FRAGM_NONE_OR_MINIMIZE = 0x01,
} data_fragm_t;
...
/* Scanning_PHYs */
typedef enum {
	SCAN_PHY_1M = BIT(0), SCAN_PHY_CODED = BIT(2), SCAN_PHY_1M_CODED = (SCAN_PHY_1M | SCAN_PHY_CODED),
} scan_phy_t;
...
typedef enum {
	DUPE_FLTR_DISABLE = 0x00, DUPE_FLTR_ENABLE = 0x01, DUPE_FLTR_ENABLE_RST_PERIOD = 0x02,
} dupe_fltr_en_t;
...
/* Initiating_PHYs */
typedef enum {
	INIT_PHY_1M = BIT(0), INIT_PHY_2M = BIT(1), INIT_PHY_CODED = BIT(2), INIT_PHY_1M_2M = (INIT_PHY_1M | INIT_PHY_2M), INIT_PHY_1M_CODED = (INIT_PHY_1M
			| INIT_PHY_CODED), INIT_PHY_2M_CODED = (INIT_PHY_2M | INIT_PHY_CODED), INIT_PHY_1M_2M_CODED = (INIT_PHY_1M | INIT_PHY_2M | INIT_PHY_1M_CODED),
} init_phy_t;
...
typedef enum {
	...
	SYNC_ADV_SPECIFY = 0, SYNC_ADV_FROM_LIST = BIT(0),
...
typedef enum {
	PPM_251_500 = 0x00, PPM_151_250 = 0x01, PPM_101_150 = 0x02, PPM_76_100 = 0x03, PPM_51_75 = 0x04, PPM_31_50 = 0x05, PPM_21_30 = 0x06, PPM_0_20 = 0x07,
} slv_clk_accuracy_t;

/* Packing */
typedef enum {
	PACK_SEQUENTIAL = 0x00, PACK_INTERLEAVED = 0x01,
} packing_type_t;

/* Framing */
typedef enum {
	UNFRAMED = 0x00, FRAMED = 0x01,
} framing_t;
