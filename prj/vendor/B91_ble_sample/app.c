 ...
 */
const u8 tbl_scanRsp[] = { 0x08, 0x09, 'e', 'S', 'a', 'm', 'p', 'l', 'e', };
...
void app_switch_to_indirect_adv(u8 e, u8 *p, int n) {
	...
	bls_ll_setAdvParam(ADV_INTERVAL_30MS, ADV_INTERVAL_35MS, ADV_TYPE_CONNECTABLE_UNDIRECTED, app_own_address_type, 0, NULL, BLT_ENABLE_ADV_ALL, ADV_FP_NONE);
...
void blt_pm_proc(void) {
	...
	if (!blc_ll_isControllerEventPending()) {  //no controller event pending
		...
		else if (device_in_connection_state && clock_time_exceed(latest_user_event_tick, CONN_IDLE_ENTER_DEEP_TIME * 1000000)) {
...
//////////////////////////// BLE stack Initialization  End //////////////////////////////////
	...
	{
		//set direct adv
		u8 status = bls_ll_setAdvParam(ADV_INTERVAL_30MS, ADV_INTERVAL_35MS, ADV_TYPE_CONNECTABLE_DIRECTED_LOW_DUTY, app_own_address_type,
				bondInfo.peer_addr_type, bondInfo.peer_addr, BLT_ENABLE_ADV_ALL, ADV_FP_NONE);
