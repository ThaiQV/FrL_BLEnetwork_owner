...
//		P_INFO_HEX(wifi_cmd_buffer,wifi_cmd_buffer[1]+3,"WIFI(idx:%d)->",indx_start);
		for (u8 i = 0; i < GWIFI_SIZE; i++) {
		...
		indx_start = indx_start + SIZEU8(BLE_WIFI_HDR) + wifi_cmd_buffer[1]+3;//len + cmdid+ crc
	}
}
