...
u8 Button_RESET(fl_exButton_states_e _state, void *_data) {
	...
	product_counter_get_data(data);
	fl_api_slave_req(NWK_HDR_55,data,sizeof(data),&_rsp_callback,800);
